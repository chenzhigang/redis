...
public class WatchController {
     ...
     */
    @PostMapping("/seckill")
    public ResultVO<List<String>> seckill(@Valid @RequestBody SeckillModel seckillModel) {
        return ResultVO.success(watchService.seckillByWatch(seckillModel.getGoodsInfo()));
    }
